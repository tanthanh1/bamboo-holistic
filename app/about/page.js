            ...
            <div className="bg-secondary mb-4 pb-8">
                ...
                <div className=" max-w-[1080px] mx-auto pt-20">
                    ...
                    <p className="mt-6">
                        ...
                        dụng rộng rãi hiện nay trên thế giới như: Chiropractic:
                        Đây là phương pháp mà người trị liệu sử dụng kĩ thuật
                        bằng tay giúp điều chỉnh những sai lệch vị trí của hệ
                        xương khớp và hệ thần kinh trong cơ thể(đặc biệt là cột
                        sống) gây ra các triệu chứng đau-mỏi-mất cân bằng tư thế
                        hoặc hạn chế vận động. Ông tổ là Daniel David
                        Palmer(1845-1913) bắt đầu sử dụng điều trị từ năm 1895.
                        Osteopathy: Ông tổ là Andrew Taylor Still(1828-1917),
                        giới thiệu bộ môn vào năm 1874. Phương pháp này tiếp cận
                        toàn bộ cơ thể người bởi quan niệm “cơ thể con người
                        giống như một cỗ máy, một cỗ máy sẽ hoạt động tốt nếu
                        tất cả các bộ phận của nó đều hoạt động tốt”. Do đó,
                        ngoài việc tiếp cận hệ xương khớp, họ còn tác động lên
                        cơ mạc(Myofascial), nội tạng(Visceral manipulation) hoặc
                        hệ thần kinh trung ương(Cranial Sacral)... Applied
                        Kinesiology(AK) là một hệ thống đánh giá 3 khía cạnh của
                        Tam giác sức khỏe: Cấu trúc, Chuyển hóa và Tinh thần
                        bằng cách sử dụng test cơ kết hợp với các tiêu chuẩn
                        chẩn đoán khác. Đây một hệ thống đánh giá chức năng cơ
                        thể không xâm lấn, độc nhất trong nghệ thuật chữa bệnh,
                        đã trở thành một phong trào mạnh mẽ trong lĩnh vực chăm
                        sóc sức khỏe trong thời gian phát triển tương đối ngắn.
                        Đây là trường phái trị liệu tự nhiên đa dạng, phong phú
                        nhất hiện nay(đồng thời cũng là phương pháp khó tiếp cận
                        bậc nhất)
                    </p>
